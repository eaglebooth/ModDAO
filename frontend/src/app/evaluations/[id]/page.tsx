...
export default function EvaluationPage(){
  ...
  const[msg,setMsg]=useState(contract?"Press sync to load this evaluation.":"V2 deployment pending.");
  ...
  const actions=[["Review",`/evaluations/${id}/review`],["Appeal",`/evaluations/${id}/appeal`],["Appeal jury",`/evaluations/${id}/appeal/review`],["Finalize",`/evaluations/${id}/finalize`]];
